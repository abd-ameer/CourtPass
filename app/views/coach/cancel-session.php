<div class="page-header">
 ...
 <span class="breadcrumb-separator">/</span>
 <a href="<?= url('/coach/session-details') ?>?id=CS-208">#CS-208</a>
 <span class="breadcrumb-separator">/</span>
 <span>Cancel</span>
 </div>
 ...
 <div class="text-xs text-muted">Session #CS-208</div>
 </div>
 <div>
 ...
 <a href="<?= url('/coach/session-details') ?>?id=CS-208" class="btn btn-secondary" style="width: 100%; text-align: center;">
 ← Keep Session Active
 </a>
 </div>
 </div>
...
function confirmCancelSession() {
 ...
 CourtPassApp.showToast('success', 'Session Cancelled', 'Session #CS-208 has been cancelled. All 3 students have been notified and refunds initiated.');
 setTimeout(() => {
