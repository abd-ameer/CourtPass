<div class="page-header">
 ...
 <option value="ses-1" selected>Advanced Smash & Footwork Drills · Today, 18:00 - 19:00 (CR&FC Court 1)</option>
 <option value="ses-2">Beginners Badminton Foundation · Tomorrow, 08:00 - 09:00 (Colombo Futsal Club)</option>
 <option value="ses-3">Spin & Net Play Mastery · 24 Sep, 17:00 - 18:00 (Otters Squash Court)</option>
 </select>
 </div>
 ...
 <button type="button" class="btn btn-sm att-btn" onclick="setAttendance(this, 'excused')" style="background: transparent; color: var(--color-text-subtle); border-radius: 9999px; padding: 4px 12px; font-size: 11px;">Excused</button>
 </div>
 </td>
 <td>
 <input type="text" class="form-control" placeholder="Optional note..." style="padding: 4px 8px; font-size: 11px; height: 28px;" value="On time">
 </td>
 </tr>

 <!-- Row 2 -->
 <tr data-student-id="st-102">
 ...
 <td>
 <input type="text" class="form-control" placeholder="Optional note..." style="padding: 4px 8px; font-size: 11px; height: 28px;">
 </td>
 </tr>

 <!-- Row 3 -->
 <tr data-student-id="st-103">
 ...
 <td>
 <input type="text" class="form-control" placeholder="Optional note..." style="padding: 4px 8px; font-size: 11px; height: 28px;" value="No show - no notice">
 </td>
 </tr>

 <!-- Row 4 -->
 <tr data-student-id="st-104">
...
function updateLiveCounts() {
 ...
 document.getElementById('stat-absent').textContent = absent + excused;
...
function markAll(type) {
 ...
 CourtPassApp.showToast(`All students marked as ${type}`, 'info');
}
...
function resetAttendance() {
 ...
 updateLiveCounts();
 CourtPassApp.showToast('Attendance reset to unmarked', 'info');
}
...
function saveAllAttendance() {
 CourtPassApp.showToast('Attendance recorded successfully! Student sports diaries updated.', 'success');
}

function exportAttendance() {
 CourtPassApp.showToast('Generating CSV export of session attendance...', 'info');
}

function switchSession(sesId) {
 CourtPassApp.showToast('Loaded attendance sheet for selected session', 'info');
}
</script>
