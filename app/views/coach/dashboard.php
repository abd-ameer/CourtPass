<div class="page-header">
 ...
 <a href="<?= url('/coach/attendance') ?>" class="btn btn-outline">
 Attendance Desk
 </a>
 </div>
 </div>
 ...
 <div class="text-xs text-muted">Session #CS-201 · 1 Hour</div>
 </td>
 <td>
 ...
 <a href="<?= url('/coach/attendance') ?>?id=CS-201" class="btn btn-sm btn-primary">Mark Attendance</a>
 </td>
 </tr>
 <tr>
 <td>
 <strong>Advanced Doubles Strategy</strong>
 <div class="text-xs text-muted">Session #CS-205 · 1 Hour</div>
 </td>
 <td>
 ...
 <a href="<?= url('/coach/attendance') ?>?id=CS-205" class="btn btn-sm btn-primary">Mark Attendance</a>
 </td>
 </tr>
 </tbody>
 </table>
