<div class="page-header">
 ...
 <div class="text-xs text-muted">#2 · LKR 1,500/person</div>
 </td>
 <td>
 ...
 <a href="<?= url('/coach/sessions/2/edit') ?>" class="btn btn-sm btn-outline">Edit</a>
 <a href="<?= url('/coach/sessions/2/attendance') ?>" class="btn btn-sm btn-primary">Attendance</a>
 </div>
 </td>
 </tr>
 <tr data-status="upcoming">
 ...
 <div class="text-xs text-muted">#1 · LKR 2,000/person</div>
 </td>
 <td>
 ...
 <a href="<?= url('/coach/sessions/1/edit') ?>" class="btn btn-sm btn-outline">Edit</a>
 <a href="<?= url('/coach/sessions/1/attendance') ?>" class="btn btn-sm btn-primary">Attendance</a>
 </div>
 </td>
 </tr>
 <tr data-status="upcoming">
 ...
 <div class="text-xs text-muted">#3 · LKR 1,500/person</div>
 </td>
 <td>
 <strong>CR&FC Badminton Complex</strong>
 <div class="text-xs text-muted">Court 1 (Synthetic)</div>
 ...
 <td style="text-align: right;">
 <div style="display: flex; gap: 6px; justify-content: flex-end;">
 <a href="<?= url('/coach/sessions/3') ?>" class="btn btn-sm btn-outline">View</a>
 <a href="<?= url('/coach/sessions/3/edit') ?>" class="btn btn-sm btn-outline">Edit</a>
 <a href="<?= url('/coach/sessions/3/cancel') ?>" class="btn btn-sm btn-secondary" style="color: var(--color-danger);">Cancel</a>
 </div>
 </td>
 </tr>
 ...
 <div class="text-xs text-muted">#1 · LKR 1,200/person</div>
 </td>
 <td>
 <strong>CR&FC Badminton Complex</strong>
 ...
 <td style="text-align: right;">
 <a href="<?= url('/coach/sessions/1') ?>" class="btn btn-sm btn-outline">View Report</a>
 </td>
 </tr>
 <tr data-status="completed">
 <td>
 <strong>Smash Technique Workshop</strong>
 <div class="text-xs text-muted">#1 · LKR 1,800/person</div>
 </td>
 <td>
 <strong>Royal College Sports Complex</strong>
 <div class="text-xs text-muted">Court 1 (Synthetic)</div>
 ...
 <div class="text-xs text-muted">#1 · LKR 1,000/person</div>
 </td>
 <td>
 <strong>CR&FC Badminton Complex</strong>
 <div class="text-xs text-muted">Court 2 (Wooden)</div>
 ...
 <div class="text-xs text-muted">#1 · LKR 1,500/person</div>
 </td>
 <td>
 <strong>Royal College Sports Complex</strong>
