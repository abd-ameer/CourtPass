<div class="page-header">
 ...
 <form id="createSessionForm" onsubmit="return handleCreateSession(event)">
 ...
 <input type="text" class="form-input" placeholder="e.g. Badminton Fundamentals" required id="sessionTitle">
 <div class="form-hint">Choose a clear, descriptive name for public discovery.</div>
 </div>

 <div class="form-group">
 <label class="form-label">Description *</label>
 <textarea class="form-input" rows="4" placeholder="Describe what students will learn in this session..." required id="sessionDesc"></textarea>
 ...
 <select class="form-input" required id="sessionSport">
 ...
 <select class="form-input" required id="sessionLevel">
 ...
 <option value="crfc">CR&FC Badminton Complex</option>
 <option value="royal">Royal College Sports Complex</option>
 </select>
 <div class="form-hint">Only venues that have approved your coaching request are shown.</div>
 </div>
 <div class="form-group">
 <label class="form-label">Court *</label>
 <select class="form-input" required id="sessionCourt">
 ...
 <input type="date" class="form-input" required id="sessionDate" min="2026-09-22">
 </div>
 <div class="form-group">
 <label class="form-label">Start Time *</label>
 <select class="form-input" required id="sessionTime">
 ...
 <input type="number" class="form-input" value="8" min="1" max="20" required id="sessionCapacity">
 <div class="form-hint">Maximum number of students allowed (1–20).</div>
 </div>
 <div class="form-group">
 <label class="form-label">Fee per Person (LKR) *</label>
 <input type="number" class="form-input" value="1500" min="0" required id="sessionFee">
 ...
 <input type="radio" name="sessionType" value="public" checked style="margin-top: 3px;">
 <div>
 ...
 <input type="radio" name="sessionType" value="private" style="margin-top: 3px;">
 <div>
...
const courtData = {
 crfc: [
 { value: 'c1', label: 'Court 1 (Synthetic)' },
 { value: 'c2', label: 'Court 2 (Wooden)' },
 { value: 'c3', label: 'Court 3 (Training)' }
 ],
 royal: [
 { value: 'r1', label: 'Court 1 (Synthetic)' },
 { value: 'r2', label: 'Court 2 (Concrete)' }
 ]
};
...
function updateCourtOptions() {
 ...
 courtSel.innerHTML += `<option value="${c.value}">${c.label}</option>`;
 });
 }
...
function handleCreateSession(e) {
 ...
 CourtPassApp.showToast('success', 'Session Created!', `"${title}" has been scheduled successfully. Students can now register.`);
 setTimeout(() => {
 window.location.href = '<?= url('/coach/sessions') ?>';
 }, 1500);
 return false;
}
</script>
