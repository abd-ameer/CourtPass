<div class="page-header">
 ...
 <a href="<?= url('/admin/venue-approvals') ?>" class="btn btn-primary">
 Review Venues (2)
 </a>
 <a href="<?= url('/admin/coach-verifications') ?>" class="btn btn-outline">
 ...
 <a href="<?= url('/admin/venue-approvals') ?>" class="btn btn-sm btn-outline" style="width: 100%; justify-content: center; margin-top: 12px;">
 Review Venue Queue →
 </a>
 </div>
 </div>
 ...
 <a href="<?= url('/admin/coach-verifications') ?>" class="btn btn-sm btn-outline" style="width: 100%; justify-content: center; margin-top: 12px;">
 Verify Coach Badges →
 </a>
 </div>
 </div>
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 CourtPassCharts.initAdminGrowthChart('adminGrowthChart');
 }
});
</script>
