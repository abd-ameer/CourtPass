<div class="page-header">
 ...
 <div>
 <button class="btn btn-outline" onclick="CourtPassApp.showToast('All administrative alerts marked as read', 'success')">
 Mark All Read
 </button>
 </div>
 </div>
 ...
 <a href="<?= url('/admin/venue-approvals') ?>" class="btn btn-sm btn-primary">Review Application</a>
 </div>
 </div>
 </div>
 ...
 <a href="<?= url('/admin/coach-verifications') ?>" class="btn btn-sm btn-outline">Inspect Cert</a>
 </div>
 </div>
 </div>
