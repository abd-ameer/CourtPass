<div class="page-header">
 ...
 <a href="<?= url('/admin/venue-details') ?>?id=pending-1" class="btn btn-sm btn-outline">Inspect Details</a>
 <button class="btn btn-sm btn-outline" style="color: var(--color-danger); border-color: var(--color-danger);" onclick="rejectVenueModal('Grand Arena Indoor Complex', 'venue-card-1')">Reject</button>
 <button class="btn btn-sm btn-primary" onclick="approveVenue('Grand Arena Indoor Complex', 'venue-card-1')"> Approve & Publish</button>
 </div>
 </div>
 ...
 <button class="btn btn-xs btn-outline" onclick="CourtPassApp.showToast('Previewing BRN Certificate PDF...', 'info')"> BRN Certificate</button>
 <button class="btn btn-xs btn-outline" onclick="CourtPassApp.showToast('Previewing Lease Agreement PDF...', 'info')"> Lease Deed</button>
 </div>
 </div>
 </div>
 ...
 <div style="display: flex; gap: 8px;">
 <a href="<?= url('/admin/venue-details') ?>?id=pending-2" class="btn btn-sm btn-outline">Inspect Details</a>
 <button class="btn btn-sm btn-outline" style="color: var(--color-danger); border-color: var(--color-danger);" onclick="rejectVenueModal('Nugegoda Pickleball & Table Tennis Hub', 'venue-card-2')">Reject</button>
 <button class="btn btn-sm btn-primary" onclick="approveVenue('Nugegoda Pickleball & Table Tennis Hub', 'venue-card-2')"> Approve & Publish</button>
 </div>
 </div>
 ...
 <div style="display: flex; gap: 6px; margin-top: 4px; flex-wrap: wrap;">
 <button class="btn btn-xs btn-outline" onclick="CourtPassApp.showToast('Previewing BRN Certificate PDF...', 'info')"> BRN Certificate</button>
 <button class="btn btn-xs btn-outline" onclick="CourtPassApp.showToast('Previewing Insurance Deed PDF...', 'info')"> Insurance Cover</button>
 </div>
 </div>
 </div>
...
<script>
function approveVenue(name, cardId) {
 document.getElementById(cardId).style.display = 'none';
 CourtPassApp.showToast(`Venue "${name}" approved and published to public directory!`, 'success');
}

function rejectVenueModal(name, cardId) {
 const reason = prompt(`Please specify reason for rejecting "${name}":`, 'Incomplete Business Registration documentation');
 if (reason) {
 document.getElementById(cardId).style.display = 'none';
 CourtPassApp.showToast(`Venue application rejected. Rejection reason dispatched to owner email.`, 'error');
 }
}
</script>
