<div class="page-header">
 ...
 <button class="btn btn-outline" onclick="CourtPassApp.showToast('Exporting User Directory CSV...', 'info')">
 ...
 <a href="<?= url('/admin/user-details') ?>?id=usr-1092" class="btn btn-sm btn-outline">Inspect</a>
 </div>
 </td>
 </tr>
 ...
 <td>
 <div style="display: flex; gap: 6px;">
 <a href="<?= url('/admin/user-details') ?>?id=usr-2001" class="btn btn-sm btn-outline">Inspect</a>
 </div>
 </td>
 </tr>
 ...
 <td>
 <div style="display: flex; gap: 6px;">
 <a href="<?= url('/admin/user-details') ?>?id=usr-3001" class="btn btn-sm btn-outline">Inspect</a>
 </div>
 </td>
 </tr>
 ...
 <td>
 <div style="display: flex; gap: 6px;">
 <a href="<?= url('/admin/user-details') ?>?id=usr-1489" class="btn btn-sm btn-outline">Inspect</a>
 <button class="btn btn-sm btn-outline" style="color: var(--color-danger);" onclick="CourtPassApp.showToast('User suspended!', 'error')">Ban</button>
 </div>
 </td>
 </tr>
 </tbody>
