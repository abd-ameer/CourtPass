<div class="page-header">
 ...
 <button class="btn btn-outline" onclick="CourtPassApp.showToast('Security warning SMS sent to user phone', 'info')">
 Send Notice SMS
 </button>
 <button class="btn btn-outline" style="color: var(--color-danger); border-color: var(--color-danger);" onclick="banUserModal()">
 Deactivate Account
 </button>
 </div>
 </div>
 ...
 <button class="btn btn-sm btn-outline" style="width: 100%; justify-content: center;" onclick="CourtPassApp.showToast('Reliability score manually adjusted!', 'success')">
 ...
 <tr>
 <td>
 <strong style="color: var(--color-text-heading);">#CP-BK-9182</strong>
 ...
 <tr>
 <td>
 <strong style="color: var(--color-text-heading);">#CP-BK-8841</strong>
 ...
 <tr>
 <td>
 <strong style="color: var(--color-text-heading);">#CP-BK-7910</strong>
...
function banUserModal() {
 ...
 if (reason) {
 CourtPassApp.showToast('User account deactivated. Login sessions revoked.', 'error');
 }
}
</script>
