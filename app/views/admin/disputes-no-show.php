<div class="page-header">
 ...
 Booking Ref #CP-#1 · Turf Court 1 · Slot: 14 Sep 2026 (21:00 - 22:00) · LKR 5,000 Cash-on-Arrival
 </div>
 </div>

 <div style="display: flex; gap: 8px;">
 <button class="btn btn-sm btn-outline" style="color: var(--color-danger); border-color: var(--color-danger);" onclick="CourtPassApp.confirmDialog('Keep Penalty', 'Dismiss the dispute and keep the no-show penalty?', 'Dismiss Dispute', () => CourtPass.post('/admin/disputes/no-show/1/resolve', { outcome: 'dismissed' }))">
 Uphold Penalty (Keep 50% Restricted)
 </button>
 <button class="btn btn-sm btn-primary" onclick="CourtPassApp.confirmDialog('Clear Penalty', 'Uphold the dispute, clear the no-show and recalculate the reliability score?', 'Uphold Dispute', () => CourtPass.post('/admin/disputes/no-show/1/resolve', { outcome: 'upheld' }))">
