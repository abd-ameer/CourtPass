...
<aside class="dashboard-sidebar">
    <div class="sidebar-brand">
        <a href="<?= url('/') ?>" style="display: flex; align-items: center; text-decoration: none;">
            <img src="<?= asset('img/courtpasslogo.png') ?>" alt="<?= e(APP_NAME) ?>" class="brand-logo-img" style="height: 38px; max-width: 160px; object-fit: contain;">
        </a>
    </div>
    ...
    <?php if ($role === 'customer'): ?>
        ...
        <a href="<?= url('/venues') ?>" class="sidebar-link <?= is_active_route('/venues', $currentPath) ?>">
        ...
        <a href="<?= url('/customer/releases') ?>" class="sidebar-link <?= is_active_route('/customer/releases', $currentPath) ?>">
        ...
        <a href="<?= url('/coaching') ?>" class="sidebar-link <?= is_active_route('/coaching', $currentPath) ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            Join Sessions
        </a>
        <a href="<?= url('/customer/sessions') ?>" class="sidebar-link <?= is_active_route('/customer/sessions', $currentPath) ?>">
    ...
    <?php elseif ($role === 'owner'): ?>
        ...
        <a href="<?= url('/owner/slots') ?>" class="sidebar-link <?= is_active_route('/owner/slots', $currentPath) ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
            Slot Grid &amp; Blocks
        </a>
    ...
    <?php elseif ($role === 'coach'): ?>
        ...
        <a href="<?= url('/coach/sessions/create') ?>" class="sidebar-link <?= is_active_route('/coach/sessions/create', $currentPath) ?>">
    ...
    <?php elseif ($role === 'admin'): ?>
        ...
        <a href="<?= url('/admin/reviews') ?>" class="sidebar-link <?= is_active_route('/admin/reviews', $currentPath) ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
            Review Moderation
        </a>
