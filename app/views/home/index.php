    ...
    <div class="container">
        <div style="max-width: 780px; margin: 0 auto; text-align: center;">
            ...
            <p class="lead" style="margin-bottom: var(--space-6); max-width: 620px; margin-left: auto; margin-right: auto; color: var(--color-text-muted);">
                Instant slot reservations for Badminton, Futsal, Pickleball, Squash, Table Tennis, Carrom and Billiards across Sri Lanka.
            </p>
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <select name="sport" class="form-select">
                            ...
                            <?php foreach ($sports as $sport): ?>
                                <option value="<?= e($sport['code']) ?>"><?= e($sport['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
...
<section style="padding: var(--space-6) 0; background: var(--color-white); border-bottom: 1px solid var(--color-border);">
    <div class="container">
        ...
        <div class="sport-chips-bar">
            <?php foreach ($sports as $sport): ?>
                <a href="<?= url('/venues?sport=' . urlencode($sport['code'])) ?>" class="sport-chip">
                    <strong><?= e($sport['name']) ?></strong> (<?= e($sport['venue_count']) ?>)
                </a>
            <?php endforeach; ?>
        </div>
    </div>
...
<section style="padding: var(--space-10) 0;">
    <div class="container">
        <div style="display: flex; align-items: flex-end; justify-content: space-between; margin-bottom: var(--space-6); flex-wrap: wrap; gap: 12px;">
            <div>
                <h2 style="font-size: var(--font-size-xl); color: var(--color-navy);">Featured Venues</h2>
                <p class="text-sm" style="margin-bottom: 0; color: var(--color-text-muted);">Approved venues with live slot availability</p>
            </div>
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="card" style="text-align: center; padding: var(--space-6);">
                ...
                <p class="text-sm" style="color: var(--color-text-muted); line-height: 1.5;">
                    Venue verifies your arrival. Keep a clean attendance record to raise your reliability score, and leave verified reviews.
                </p>
            </div>
        </div>
    </div>
