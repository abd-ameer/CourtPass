<div class="page-header">
 ...
 <a href="<?= url('/customer/create-review') ?>" class="btn btn-primary">
 + Write New Review
 </a>
 </div>
 ...
 <a href="<?= url('/customer/create-review') ?>?edit=rev-1" class="btn btn-sm btn-outline">Edit</a>
 <button class="btn btn-sm btn-secondary" style="color: var(--color-danger);" onclick="deleteReview('rev-1')">Delete</button>
 </div>
 </div>
 <div class="card-body">
 ...
 <div style="display: flex; gap: 8px;">
 <a href="<?= url('/customer/create-review') ?>?edit=rev-2" class="btn btn-sm btn-outline">Edit</a>
 <button class="btn btn-sm btn-secondary" style="color: var(--color-danger);" onclick="deleteReview('rev-2')">Delete</button>
 </div>
 </div>
 <div class="card-body">
 <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
...
function deleteReview(revId) {
 ...
 'Delete Review (Review CRUD Delete)',
 'Are you sure you want to permanently delete this verified review?',
 'Yes, Delete Review',
 function() {
 CourtPassApp.showToast('success', 'Review Deleted', 'Your review has been successfully removed.');
