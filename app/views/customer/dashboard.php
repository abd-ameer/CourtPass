<div class="page-header">
 ...
 <div class="stat-label">Market Resales</div>
 </div>
 </div>
 ...
 <!-- Resale Marketplace & Quick Actions -->
 <div class="grid grid-cols-2 gap-6">
 
 <!-- Resale Marketplace Teaser -->
 <div class="card">
 <div class="card-header">
 <h3 style="font-size: 15px; font-weight: 700; margin-bottom: 0;">Resale Ticket Deals</h3>
 <span class="badge badge-confirmed">Max 90% Price Cap</span>
 </div>
 <div class="card-body">
 <p class="text-xs" style="color: var(--color-text-muted); margin-bottom: 12px;">
 Pick up discounted court reservations listed by verified players unable to attend.
 </p>
 ...
 <div class="text-xs" style="color: var(--color-text-muted);">Sept 25 · 09:00 PM - 10:00 PM</div>
 </div>
 <div style="text-align: right;">
 <div style="font-size: 14px; font-weight: 800; color: var(--color-primary-hover);">LKR 3,800</div>
 <div class="text-xs" style="color: var(--color-warning); font-weight: 700;">16% OFF</div>
 </div>
 </div>

 <a href="<?= url('/customer/resale') ?>" class="btn btn-outline" style="width: 100%; justify-content: center; margin-top: 10px;">
 Browse Resale Marketplace &rarr;
 </a>
 </div>
 </div>
