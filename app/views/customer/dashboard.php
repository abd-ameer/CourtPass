    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <strong style="font-family: monospace; color: var(--color-navy);">#CP-#3</strong>
                ...
                <tr>
                    <td>
                        <strong style="font-family: monospace; color: var(--color-navy);">#CP-#12</strong>
                    ...
                    <td>
                        <a href="<?= url('/sessions/2') ?>" class="btn btn-sm btn-outline">Session Info</a>
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                <a href="<?= url('/venues?sport=futsal') ?>" class="btn btn-sm btn-outline" style="justify-content: flex-start;">
                    Futsal Courts in Colombo (8 Venues)
                </a>
                <a href="<?= url('/venues?sport=badminton') ?>" class="btn btn-sm btn-outline" style="justify-content: flex-start;">
                    Badminton Courts (12 Venues)
                </a>
                <a href="<?= url('/coaching') ?>" class="btn btn-sm btn-outline" style="justify-content: flex-start;">
