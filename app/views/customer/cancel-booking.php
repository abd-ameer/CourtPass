...
<div class="page-header">
 ...
 <div class="page-subtitle">Review policy implications, refund calculations, or choose to resell.</div>
 </div>
 </div>
 ...
 <span class="badge" style="background: #fef3c7; color: #92400e;">50% Refund Applicable</span>
 </div>
 <p class="text-xs" style="color: #78350f; margin-bottom: 12px; line-height: 1.5;">
 Because you are cancelling between 12 and 48 hours before match start, our automated policy refunds 50% (<strong>LKR 2,500</strong>) via PayHere Sandbox.
 </p>
 ...
 <div>
 <strong style="font-size: 13px; color: var(--color-text-title);">Want to recover up to 90% instead?</strong>
 <div class="text-xs text-muted">List this pass on the CourtPass Resale Marketplace for up to <strong>LKR 4,500</strong>.</div>
 </div>
 <a href="<?= url('/customer/my-resales') ?>?list=BK-9021" class="btn btn-primary btn-sm">
 List for Resale &rarr;
 </a>
 </div>
 </div>
