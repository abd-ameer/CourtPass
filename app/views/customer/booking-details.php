...
<div class="page-header">
 ...
 <div>
 <!-- Resale Eligibility Card (UC-CU-10) -->
 <div class="card" style="margin-bottom: var(--space-6);">
 <div class="card-header">
 <h3 style="font-size: 15px; margin-bottom: 0;">Resale Safeguard</h3>
 <span class="badge badge-flash">Max 90% Price</span>
 </div>
 <div class="card-body">
 <p class="text-sm" style="color: var(--color-text-muted); margin-bottom: 12px;">
 Unable to attend? List your booking on the community Resale Marketplace to recover up to 90% of your booking fee.
 </p>
 <?php if ($is_cash): ?>
 <div style="padding: 10px; background: #fef3c7; border-radius: var(--radius-md); font-size: 12px; color: #92400e; margin-bottom: 12px;">
 <strong>Cash-on-Arrival Conversion Required:</strong> You must convert this booking to online payment before listing it on the resale marketplace.
 </div>
 ...
 List for Resale (Max LKR 4,500) &rarr;
 </a>
 <?php endif; ?>
 </div>
 </div>
 ...
 <strong>12 to 48 Hours Before:</strong> 50% Refund or List for Resale.
 </div>
