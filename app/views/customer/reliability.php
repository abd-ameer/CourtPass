...
<div id="noShowDisputeModal" class="modal-backdrop">
 ...
 <form onsubmit="handleDisputeSubmit(event)">
 <div class="form-group">
 <label class="form-label">Select Contested Booking</label>
 <select class="form-select" required>
 <option value="">Choose booking...</option>
 <option>BK-8810: Otters Club Squash (Sept 18)</option>
 <option>BK-8604: SpinMaster TT Club (Sept 12)</option>
 </select>
 </div>
 <div class="form-group">
 <label class="form-label">Explanation & Evidence <span class="required-star">*</span></label>
 <textarea class="form-control" rows="3" placeholder="Explain what happened at the venue (e.g. front desk was unattended, venue confirmed verbally...)" required></textarea>
 </div>
...
function handleDisputeSubmit(e) {
 e.preventDefault();
 CourtPassApp.closeModal('noShowDisputeModal');
 CourtPassApp.showToast('success', 'Dispute Logged', 'Your dispute has been submitted to the Platform Admin queue for investigation.');
}
</script>
