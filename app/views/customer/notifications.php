<div class="page-header">
 ...
 <strong style="color: var(--color-text-title); font-size: 14px;">Booking Confirmed (#3)</strong>
 ...
 <a href="<?= url('/courts/1') ?>" style="font-size: 12px; font-weight: 700;">Claim Flash Slot &rarr;</a>
 </div>
 </div>
 ...
 <a href="<?= url('/sessions/2') ?>" style="font-size: 12px; font-weight: 700; color: #7c3aed;">View Clinic Details &rarr;</a>
 </div>
 </div>
