...
<div class="page-header">
 ...
 <h1 class="page-title">Booking <?php echo htmlspecialchars($booking_id); ?> Overview</h1>
 <span class="badge badge-confirmed">Confirmed</span>
 <span class="badge badge-paid">Online Paid</span>
 </div>
 <div class="page-subtitle">Pass Code: <strong>CP-78190</strong> · Turf Court 1 · Sept 24, 2026 (08:00 PM - 09:00 PM)</div>
 </div>

 <div style="display: flex; gap: 8px;">
 <a href="<?= url('/owner/check-in') ?>?search=CP-78190" class="btn btn-primary">
 Check-in Customer
 </a>
 </div>
 </div>
 ...
 <div class="text-xs text-muted">Rank #1 Most Active</div>
 </div>
 <div style="background: var(--color-bg-subtle); padding: 12px; border-radius: var(--radius-md);">
 ...
 <strong style="color: var(--color-primary-active);">CP-78190-PH-PAY</strong>
 </div>
 ...
 <a href="<?= url('/owner/check-in') ?>?search=CP-78190" class="btn btn-primary flex-1">
 Check-in Customer
 </a>
 <button type="button" class="btn btn-secondary flex-1" style="color: var(--color-danger);" onclick="promptOwnerCancel()">
 Cancel Reservation...
 </button>
 </div>
 </div>
...
<script>
function promptOwnerCancel() {
 document.getElementById('reasonModalTitle').textContent = 'Owner Cancel Booking BK-9021';
