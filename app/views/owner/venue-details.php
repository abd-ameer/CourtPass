<div class="page-header">
 ...
 <a href="<?= url('/owner/edit-venue') ?>?id=venue-1" class="btn btn-outline">
 Edit Venue Info
 </a>
 <a href="<?= url('/owner/courts') ?>?venue=venue-1" class="btn btn-primary">
 ...
 <a href="<?= url('/owner/slot-management') ?>" class="btn btn-outline btn-block" style="justify-content: flex-start;">
 ...
 <a href="<?= url('/owner/delete-venue') ?>?id=venue-1" class="btn btn-secondary btn-block" style="color: var(--color-danger); justify-content: flex-start;">
 Deactivate Venue...
 </a>
 </div>
 </div>
