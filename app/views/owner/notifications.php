<div class="page-header">
 ...
 <button class="btn btn-outline" onclick="markAllOwnerRead()">
 ...
 <div style="display: flex; gap: 6px; flex-shrink: 0;">
 <a href="<?= url('/owner/slot-management') ?>" class="btn btn-sm btn-outline">View Grid</a>
 </div>
 </div>
 </div>
 </div>
...
function markAllOwnerRead() {
 ...
 CourtPassApp.showToast('All owner notifications marked as read', 'success');
}
</script>
