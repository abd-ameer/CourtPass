<div class="page-header">
 ...
 <option value="2">Kandy Court Zone</option>
 </select>
 </div>
 <div class="form-group">
 ...
 <input type="text" name="title" class="form-control" maxlength="150" placeholder="e.g., Floodlight upgrade completed on Court 1" required>
 </div>
