<div class="page-header">
 ...
 <button class="btn btn-outline" onclick="CourtPassApp.showToast('Exporting Customer Directory (CSV)...', 'info')">
 ...
 <!-- Top Player Spotlight ("Most Active This Month") -->
 <div class="card" style="margin-bottom: var(--space-6); background: linear-gradient(135deg, #171c1a 0%, #2a3530 100%); color: #ffffff;">
 <div class="card-body" style="padding: var(--space-6);">
 <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
 <div style="display: flex; align-items: center; gap: 16px;">
 <div style="width: 64px; height: 64px; border-radius: var(--radius-full); background: var(--color-primary-active); color: #ffffff; display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: 900; border: 3px solid rgba(255,255,255,0.2);">
 
 </div>
 <div>
 <span class="badge" style="background: rgba(0, 181, 98, 0.25); color: #4ade80; border: 1px solid rgba(74, 222, 128, 0.4); margin-bottom: 4px;">
 Most Active Player This Month (Colombo Futsal Club)
 </span>
 <h3 style="font-size: 20px; font-weight: 800; color: #ffffff; margin-bottom: 2px;">
 Sahan Jayasuriya
 </h3>
 <div style="font-size: 12px; color: #9ca3af;">
 6 Bookings Completed (12 hours played) · 100% Reliability Score · LKR 60,000 Spend
 </div>
 </div>
 </div>

 <div style="display: flex; gap: 12px;">
 <button class="btn btn-primary" onclick="CourtPassApp.showToast('Special loyalty discount promo code sent to Sahan via SMS!', 'success')">
 Reward with Promo Voucher
 </button>
 </div>
 </div>
 </div>
...
function viewCustomerModal(name, score, bookings, noShows, spend) {
 CourtPassApp.showToast(`Viewing intelligence profile for ${name}`, 'info');
}
</script>
